...
const measureScaleDisplay = document.getElementById('measureScaleDisplay');
...
const settingMeasureMode = document.getElementById('settingMeasureMode');
const settingMeasureScale = document.getElementById('settingMeasureScale');
const settingMeasureShowSegmentLen = document.getElementById('settingMeasureShowSegmentLen');
const settingMeasureShowArea = document.getElementById('settingMeasureShowArea');
const settingMeasureShowSegLabel = document.getElementById('settingMeasureShowSegLabel');
const settingMeasureShowHatch = document.getElementById('settingMeasureShowHatch');
const settingMeasureLabelFontSize = document.getElementById('settingMeasureLabelFontSize');
const settingMeasureHatchSpacing = document.getElementById('settingMeasureHatchSpacing');
const settingMeasureHatchOpacity = document.getElementById('settingMeasureHatchOpacity');
